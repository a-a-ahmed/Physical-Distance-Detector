...
def __generate_partial_image(picture, partial_image, position):
    """
    This function generates embeds a partial image to our final picture
    """
...
def __generate_text(image, text, target_size, font_scale, color, thickness):
    """
    This function paints text on our final image
    """
    cv2.putText(
        image,
        text,
...
def __generate_logo(path_image, target_size=(280,100)):
    """
    This function will generate the logo
    """
...
def generate_bird_eye_view(good, bad):
    """
    This function generates the Bird Eye view with the green and red mapped dots
    """
    red = (255,0,0)
    green = (0,255,0)
...
def generate_picture():
    """
    This function generates the box where the people detections and the Bird Eye view will be generated.
    """
    ...
    __generate_text(image=background,
                text="Social Distance Detector using OpenCV",
                target_size=(400, 90),
                font_scale=3,
                color=text_color,
                thickness=4)
    ...
    __generate_text(image=background,
                text="Project Created by Adnaan Arbaaz Ahmed",
                target_size=(10, 1230),
                font_scale=1.2,
                color=text_color,
                thickness=2)
...
def generate_content_view(picture, image, bird_eye_view):
    """
    This function generates the content of our final view, that is, it embeds the image or frame of the original video
    with detections and also embeds the bird eye view with dots.
    """
